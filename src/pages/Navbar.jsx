      ...
      <div className="navbar-end gap-3">
        {user ? (
          <div className="rounded-full dropdown dropdown-hover text-white">
            <img src={user.photoURL} alt="https://i.ibb.co/CMRVWhH/B5.jpg" className="w-12 rounded-full"></img>
            <ul
              tabIndex={0}
          ...
          <Link to="/login">
            <a className="btn  bg-gradient-to-r from-yellow-500 from-10% via-sky-500 via-30% to-emerald-500 to-90% text-white">Log In</a>
          </Link>
        )}
