        ...
        <>
          <li className="flex ">
                <NavLink to="/" className={({isActive }) =>
                    isActive ? 'text-white bg-gradient-to-r from-blue-500 from-10% via-sky-500 via-30% to-emerald-500 to-90% font-bold border border-white' : 'font-bold text-slate-500'
                }>Home</NavLink>
            </li>
            <li className="flex ">
                <NavLink to="/about" className={({isActive }) =>
                    isActive ? 'text-white bg-gradient-to-r from-blue-500 from-10% via-sky-500 via-30% to-emerald-500 to-90% font-bold border border-white' : 'font-bold text-slate-500'
                }>All Paintings</NavLink>
            </li>
          <li className="flex ">
                <NavLink to="/addPainting" className={({isActive }) =>
                    isActive ? 'text-white bg-gradient-to-r from-blue-500 from-10% via-sky-500 via-30% to-emerald-500 to-90% font-bold border border-white' : 'font-bold text-slate-500'
                }>Add Painting</NavLink>
          </li>
          <li className="flex ">
                <NavLink to="/user" className={({isActive }) =>
                    isActive ? 'text-white bg-gradient-to-r from-blue-500 from-10% via-sky-500 via-30% to-emerald-500 to-90% font-bold border border-white' : 'font-bold text-slate-500'
                }>My Paintings</NavLink>
          </li>
    ...
    return (
        ...
        <div className="navbar-start">
          ...
          <div className="md:flex justify-center items-center gap-0">
           ...
           <a className="text-3xl font-bold  bg-gradient-to-r from-blue-500 from-10% via-yellow-500 via-30% to-emerald-500 to-90% text-transparent bg-clip-text"> PaintHaven</a></div>
