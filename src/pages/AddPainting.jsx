...
const AddPainting = () => {
    ...
    const handleAddPainting = event =>{
        ...
        const newPainting = {name, price, rating, customization, stock, photo, category, description, email, userName, time}
  ...
  return (
    <div className="bg-gradient-to-r from-slate-300 from-10% via-sky-300 via-30% to-yellow-100 to-90% p-24">
      <h2 className="text-3xl font-extrabold bg-gradient-to-r from-red-500 from-10% via-yellow-500 via-30% to-emerald-500 to-90% text-transparent bg-clip-text">Add a Painting</h2>
      <form onSubmit={handleAddPainting} className="border p-5 rounded-2xl mt-10">
        ...
        <input type="submit" value="Add Painting" className="btn btn-block bg-gradient-to-r from-yellow-500 from-10% via-sky-500 via-30% to-emerald-500 to-90% font-bold text-white"  />
      </form>
    </div>
  );
};
